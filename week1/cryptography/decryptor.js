...
let getKeyFromBinaryExpectedMostCommonLetter = (
  ...
  const encryptedLetterBinary = convert(mostCommonEncryptedLetter);
  const expectedLetterBinary = convert(expectedMostCommonDecryptedLetter);
  let output = "";
